...
<head>
    ...
    <link rel = "icon" href ="/webbanhang/img/logo.jpg" type = "image/x-icon">
    
    <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="assetsForSideBar/css/styles.css">
    
    <link rel="stylesheet" href="assetsForSideBar/css/button.css">
    <div ontouchstart="">
        <div class="button">
            <a href="http://localhost/webbanhang">Back to Home Page</a>
        </div>
    </div>
</head>
